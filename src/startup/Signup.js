...
export default class Signup extends Component<Props> {
  ...
  componentWillMount = async () => {
    ...
    GoogleSignin.configure({
      ...
      webClientId: '168494380414-j7533q2p386s46srnktvf830cdcb4ujs.apps.googleusercontent.com', // client ID of type WEB for your server (needed to verify user ID and offline access)
      offlineAccess: true, // if you want to access Google API on behalf of the user FROM YOUR SERVER
      iosClientId: '168494380414-62teeq7udk6d6kvjd8datldrpqkicn0m.apps.googleusercontent.com', // [iOS] optional, if you want to specify the client ID of type iOS (otherwise, it is taken from GoogleService-Info.plist)

    ...
    render() {
        return (
            <View style={{ flexDirection: 'row', backgroundColor: '#1D2127' }}>
                ...
                <View style={{ flexDirection: 'row', backgroundColor: '#14171B', height: wp(8), width: wp(85), alignSelf: 'center', borderRadius: wp(2) }}>
                    <TextInput
                        style={{ height: wp(8.5), width: '92%', paddingLeft: wp(2), borderRadius: wp(2), fontSize: wp(3), color: "#fff" }}
                        placeholder={Store.orderStore.searchbar}

...
export default class Home extends Component<Props> {
  ...
  renderBodyType = () => {
    ...
    // console.log('orderStore.bodyType',orderStore.bodyType)
    // console.log('orderStore.fe',orderStore.featuredListingType)
    // console.log('orderStore.ma',orderStore.makeType)
    ...
    switch (bodyType) {
      case "1":
        return (<View style={{ marginTop: wp(5) }}>
          ...
          <View style={[{ marginTop: wp(5), justifyContent: 'center', backgroundColor: '#1d2127', paddingVertical: wp(2), paddingLeft: wp(2), borderRadius: wp(1) }]}>
                  ...
                  >
                    ...
                    <View style={{ width: '100%', height: 100 }}>
                      <View style={[FeaturedGridStyle.textContainer, { width: '100%', backgroundColor: '#fff' }]}>
                        <Text style={[FeaturedGridStyle.brandTextStyle, { fontSize: wp(3), width: wp(48), fontWeight: '800' }]}>
                          {item.ad_title}
                        </Text>
                        <Text style={[styles.buttonTextStyle, { color: 'red', fontSize: wp(2.4), fontWeight: '700' }]}>{item.ad_price.price}
                          {
      ...
      case '6':
        return (
          <View>
            ...
            <View style={[styles.featuredGrid, { backgroundColor: '#1D2127', paddingHorizontal: wp(1) }]}>
                  ...
                  >
                    ...
                    <View style={{ width: '100%', height: 120 }}>
                      <View style={[FeaturedGridStyle.textContainer, { width: '100%', backgroundColor: '#171A1F' }]}>
                        <Text style={[FeaturedGridStyle.brandTextStyle, { fontSize: wp(3), width: wp(48), color: '#fff', fontWeight: '800' }]}>
                          {item.ad_title}
                        </Text>
      ...
      case '2':
        return (
          <View style={{ backgroundColor: '#f8f8f8', marginTop: wp(2), paddingLeft: wp(1) }}>
            ...
            <View style={[styles.featuredMakersListContainer, { width: '90%' }]}>
              <FlatList
                data={data.featured_makes}
                horizontal
                renderItem={({ item, key }) => (
          ...
          <FlatList
            ...
            renderItem={({ item, index }) =>
              ...
              <TouchableOpacity
                ...
                style={[PopularCarsStyle.container, { backgroundColor: '#f8f8f8' }]}>
          ...
          <View style={[styles.headerSearchbarContainer, {
            ...
            <TextInput
              style={[styles.TextInput, {
                ...
                // marginRight: 1,
                // marginTop: 10,
                elevation: 5, marginRight: wp('-8'), borderTopLeftRadius: wp('5'), borderBottomLeftRadius: wp('5'), borderTopRightRadius: wp('5'), borderBottomRightRadius: wp('5')
              }]}
            ...
            >
              <View style={[styles.searchButton, { zIndex: 10, paddingStart: wp('8'), height: '100%', paddingEnd: wp('8'), backgroundColor: orderStore.color, borderTopLeftRadius: wp('5'), borderBottomLeftRadius: wp('5'), borderTopEndRadius: wp('5'), borderBottomEndRadius: wp('5') }]}>

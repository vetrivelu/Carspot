...
export default class Home extends Component<Props> {
            ...
            <View style={[styles.featuredGrid, { backgroundColor: '#1d2127' }]}>
              ...
              <FlatList
                ...
                renderItem={({ item, index }) =>
                  <TouchableOpacity
                    activeOpacity={1}
                    style={[FeaturedGridStyle.container, { marginTop: wp('3'), backgroundColor: '#1d2127', width: wp('45'), borderTopLeftRadius: wp('3'), borderTopRightRadius: wp('3') }]}
  ...
  //     {/* <View style={[styles.headingContainer,{backgroundColor:'#1D2127'}]}>
  //       <Text style={styles.bodyHeadingBlack}>{data.body_type_txt1}</Text>
  //       <Text style={styles.bodyHeadingAppColor}> {data.body_type_txt2}</Text>
  //     </View> */}
  //     <View style={styles.startPadding}>
  ...
  //     </View>
  //     <View style={[styles.featuredTypeListContainer,{backgroundColor:'#1D2127'}]}>

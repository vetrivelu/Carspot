      ...
      case '1':
        return (
          <View>
            ...
            <View style={[styles.featuredGrid, { backgroundColor: '#f0f0f0' }]}>
              ...
              <FlatList
                ...
                renderItem={({ item, index }) =>
                  <TouchableOpacity
                    activeOpacity={1}
                    style={[FeaturedGridStyle.container, { marginTop: wp('3'), backgroundColor: '#f0f0f0', width: wp('45'), borderTopLeftRadius: wp('3'), borderTopRightRadius: wp('3') }]}
      ...
      case '2':
        return (
          <View style={{ backgroundColor: '#f0f0f0' }}>
            ...
            <View style={[styles.featuredGrid, { backgroundColor: '#fff', padding: wp(1) }]}>
      ...
      case '5':
        return (
          <View >
            ...
            <View style={[styles.featuredGrid, { backgroundColor: '#f8f8f8', paddingHorizontal: wp(1), marginLeft: wp(0) }]}>
                  ...
                  >
                    ...
                    <View style={{ width: '100%' }}>
                      <View style={[FeaturedGridStyle.textContainer, { width: '100%', backgroundColor: '#fff' }]}>
                        <Text style={[FeaturedGridStyle.brandTextStyle, { fontWeight: '800', width: wp(50) }]}>
                          {item.ad_title}
                        </Text>
                        <Text style={[styles.buttonTextStyle, { color: 'red', fontSize: wp(2.4), fontWeight: '700' }]}>{item.ad_price.price}
                          {
      ...
      case '6':
        return (
          <View>
            ...
            <View style={[styles.featuredGrid, { backgroundColor: '#f0f0f0', marginLeft: wp(0) }]}>
    ...
    return (
      ...
      >
        <View style={{ marginLeft: wp('4'), marginTop: wp('5') }}>
          <Text style={{ color: '#000', fontSize: wp('5'), fontWeight: 'bold' }}>{data.home_thme_header_title}</Text>
          <Text style={{ color: '#000', fontSize: wp('3') }}>{data.home_thme_header_sub_title}</Text>
        </View>
        {/* <View> */}
        {/* Header Start */}

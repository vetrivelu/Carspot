...
export default class Home extends Component<Props> {
  ...
  componentWillMount = async () => {
    ...
    if (response.success === true) {
      ...
      orderStore.searchbar=response.data.placehldr;
    ...
    switch (bodyType) {
     ...
     case "2":
      return (<View>
        ...
        <View style={[styles.featuredTypeListContainer,{backgroundColor:'#f8f8f8'}]}>
      ...
      case  '3':
        return (
          <View>
            ...
            <View style={[styles.featuredGrid,{marginLeft:wp(0)}]}>
          ...
          <View>
            <View style={styles.headingWithButtonContainer}>
              <View style={styles.headingContainer}>
                <View>
                  <View style={styles.textRowConrainer}>
                    <Text style={[styles.bodyHeadingBlack, { color: '#000' ,fontWeight: 'bold'}]}>{data.text}</Text>
                    <Text style={[styles.bodyHeadingAppColor, { color: '#000',fontWeight: 'bold' }]}> {data.text2}</Text>
                  </View>
                ...
                renderItem={({ item, index }) =>
                  ...
                  >
                    ...
                    <View style={{width:'100%',height:120}}>
                      ...
                      <Text style={[FeaturedGridStyle.brandTextStyle, { color: '#fff',width:wp(48), fontWeight: '800' }]}>
                          {item.ad_title}
                        </Text>
          ...
          <FlatList
            ...
            renderItem={({ item, index }) =>
              ...
              <TouchableOpacity
                ...
                <View style={[TopCars.listContentContainer,{backgroundColor:'#f1f1f1'}]}>
                ...
                <View style={[TopCars.listMiddleContainer,{backgroundColor:'#f1f1f1'}]}>
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <Text style={{ color: '#000', fontSize: wp('5'), fontWeight: 'bold' }}>{this.state.bannerTitle}</Text>
        <Text style={{ color: '#000', fontSize: wp('3') }}>{this.state.bannerSubtitle}</Text>
            </View>

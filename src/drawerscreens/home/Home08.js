...
export default class Home extends Component<Props> {
            ...
            <FlatList
              ...
              renderItem={({ item, index }) =>
                ...
                <TouchableOpacity
                  activeOpacity={1}
                  onPress={() => this.onFeaturedTypeClick(item)}
                  style={[{ alignContent: 'center', alignItems: 'center', backgroundColor: "#f8f8f8", borderWidth: wp(0.3), borderColor: '#f0f0f0', marginRight: wp(2) }]}
                >
                  <Animatable.View
                    duration={2000}
                    animation="zoomIn"
            ...
            <FlatList
              ...
              renderItem={({ item, index }) =>
                ...
                >
                  ...
                  <Text style={[{ color: '#000', fontSize: wp(3), backgroundColor: '#fff', paddingVertical: wp(2), paddingHorizontal: wp(4), fontWeight: '600' }]}>
                    {item.name}
                  </Text>
  ...
  renderFeaturedAdsGrid = () => {
    ...
    switch (featuredAdType) {
      ...
      case '2':
        return (
          <View style={{ backgroundColor: '#fff', marginTop: wp(3), paddingHorizontal: wp(1) }}>
      ...
      case '6':
        return (
          <View>
            ...
            <View style={[styles.featuredGrid, { backgroundColor: '#1D2127', marginLeft: wp(0), paddingHorizontal: wp(1), paddingBottom: wp(3) }]}>
        ...
        <View style={[styles.container]}>
          ...
          <View style={[styles.body, {
            ...
            >
              ...
              {this.renderBodyType()}
              <View style={{ height: wp(60), width: '100%' }}>

                <View style={[{ height: wp('50'), marginTop: wp(5), width: '100%', alignSelf: 'center', backgroundColor: orderStore.appColor, borderBottomRightRadius: wp(10) }]}>
                ...
                <Image
                  source={{ uri: data.home_theme_baner_img }}
                  resizeMode="contain"
                  style={{
                    height: wp('40'), width: wp('90'),
                    position: 'absolute', right: wp('-8'), zIndex: 10, bottom: wp('-3')

...
export default class Home extends Component<Props> {
  ...
  //               animation="zoomIn"
  //               iterationCount={1}
  //               style={[FeaturedTypeStyle.container, { paddingHorizontal: wp('2'), paddingVertical: wp('0'),borderWidth:wp('0.3'),borderColor:'#f1f1f1', backgroundColor: "#fff" }]}
  //               direction="alternate">
  //               <Image
  //                 style={FeaturedTypeStyle.image}
  //                 source={{ uri: item.img }} />
      ...
      case '2':
        return (
          <View style={{ backgroundColor: '#fff' }}>
            ...
            <View style={[styles.featuredGrid, { backgroundColor: '#fff', marginLeft: wp(1), paddingRight: wp(1) }]}>
  ...
  render() {
    ...
    return (
      ...
      >
        <View>
          {/* Header Start */}
          <View style={[styles.header, { height: wp('59'), backgroundColor: 'red', borderBottomLeftRadius: wp('8'), borderBottomRightRadius: wp('8'), paddingLeft: wp('0') }]}>

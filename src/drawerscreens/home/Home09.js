...
import { BodyType1 } from '../../helper/BodyTypes'
...
export default class Home extends Component<Props> {
            ...
            <FlatList
              ...
              renderItem={({ item, index }) =>
                ...
                <TouchableOpacity
                  activeOpacity={1}
                  onPress={() => this.onFeaturedTypeClick(item)}
                  style={[{ alignContent: 'center', alignItems: 'center', backgroundColor: "#f8f8f8", marginRight: wp(2),marginBottom:wp(2),marginLeft:wp(2) }]}
                >
                  <Animatable.View
                    duration={2000}
                    animation="zoomIn"
  ...
  renderFeaturedAdsGrid = () => {
    ...
    switch (featuredAdType) {
      case  '1':
        return (
          <View>
            ...
            <View style={[styles.featuredGrid, { backgroundColor: '#fff',paddingBottom:wp(3) }]}>
      ...
      case  '2':
        return (
          <View style={{ backgroundColor: '#fff',paddingHorizontal:wp(1) }}>
    
    
            <View style={[styles.headingWithButtonContainer,{backgroundColor:"#fff"}]}>
              <View style={styles.headingContainer}>
                <View>
                  <View style={styles.textRowConrainer}>
                    <Text style={[styles.bodyHeadingBlack]}>{data.text}</Text>
      ...
      case  '3':
        return (
          <View>
            ...
            <View style={[styles.featuredGrid,{paddingBottom:wp(3)}]}>
      ...
      case  '4':
        return (
          <View>
            ...
            <View style={[styles.featuredGrid,{backgroundColor:'#1D2127',paddingBottom:wp(3)}]}>
      ...
      case  '5':
        return (
          <View style={{backgroundColor:'#F8F8F8'}}>
            ...
            <View style={[styles.featuredGrid, { backgroundColor: '#f8f8f8' }]}>
      ...
      case  '6':
        return (
          <View>
            ...
            <View style={[styles.featuredGrid, { backgroundColor: '#1D2127',paddingHorizontal:wp(1),paddingBottom:wp(3) }]}>
  ...
  //               <View style={[FeaturedGridStyle.textContainer,{backgroundColor:'#fff'}]}>
  //                 <Text style={[styles.buttonTextStyle, { color: 'red', fontSize: wp(3), fontWeight: '700' }]}>{item.ad_price.price}
  //                   {
  //                     item.ad_price.price_type != undefined && item.ad_price.price_type != null  && item.ad_price.price_type != ""?
  //                       <Text style={[styles.buttonTextStyle, { color: 'gray' }]}>{' (' + item.ad_price.price_type + ')'}</Text>
  ...
  //                   }
  //                 </Text>
  //                 <Text style={[FeaturedGridStyle.brandTextStyle, { color:'#000',fontWeight: '800' }]}>
  //                   {item.ad_title}
  //                 </Text>
  //                 {/* <Text style = {FeaturedGridStyle.modelTextStyle}>
  //                 {item.ad_desc}
  ...
  //                   /> */}
  //                   <Text
  //                     style={[FeaturedGridStyle.petrolTextStyle,{color:'#000'}]}>
  //                     {item.ad_engine}
  //                   </Text>
  //                 </View>
  //                 {
  //                   item.ad_milage != undefined && item.ad_milage != null && item.ad_milage != "" ?
  //                     <Text style={[FeaturedGridStyle.petrolTextStyle, { color:'#000',marginLeft: wp(2) }]}>|</Text>
  //                     : []
  //                 }
  ...
  //                       <Text
  //                         style={[FeaturedGridStyle.mileageTextStyle,{color:'#000'}]}>
  //                         {item.ad_milage}
  //                       </Text>
  //                     </View> : []
  ...
  //                 padding: 10,
  //                 borderRadius: 5,
  //               }, { backgroundColor: '#fff', width: wp(28), alignItems: 'center', paddingHorizontal: wp('4'), paddingVertical: wp('2') }]}
  //             // style={data.featured_makes_column === "3" ? MakersTypeStyle.containerThreeRows : MakersTypeStyle.container}
  //             >
  //               <Animatable.View
  //                 duration={2000}
          ...
          <FlatList
            ...
            renderItem={({ item, index }) =>
              ...
              <TouchableOpacity
                ...
                style={[PopularCarsStyle.container, { backgroundColor: '#fff' }]}>
          ...
          <FlatList
            ...
            renderItem={({ item, index }) =>
              ...
              <TouchableOpacity
                ...
                <View style={[TopCars.listContentContainer, { backgroundColor: '#fff' }]}>
                ...
                <View style={[TopCars.listMiddleContainer, { backgroundColor: '#fff' }]}>
        ...
        <View style={styles.listRowContainer}>
          <FlatList
            ...
            renderItem={({ item, key }) => (
              <TouchableOpacity
                activeOpacity={1}
                style={[styles.listItemContainer, { backgroundColor: '#fff' }]}
                onPress={async () => {
                  const { navigate } = this.props.navigation;
                  await BackHandler.removeEventListener("hardwareBackPress", this.handleBackButton);
      ...
      >
        ...
        <View style={[styles.container]}>
          ...
          <View style={[styles.body, {
            ...
            {/* <View style={{ marginLeft: wp('4'), marginTop: wp('1') }}>
              <Text style={{ color: '#000', fontSize: wp('5'), fontWeight: 'bold' }}>Automotive Car Delear</Text>

...
export default class Home extends Component<Props> {
    ...
    switch (bodyType) {
      ...
      case '4':
        return (<View>
          ...
          <View style={[styles.featuredTypeListContainer, { marginTop: wp(1), marginLeft: wp(0.3) }]}>
            ...
            <FlatList
              ...
              renderItem={({ item, index }) =>
                ...
                <TouchableOpacity
                  activeOpacity={1}
                  onPress={() => this.onFeaturedTypeClick(item)}
                  style={[{ alignContent: 'center', alignItems: 'center', backgroundColor: "#f8f8f8", marginRight: wp(3), marginBottom: wp(2) }]}
                >
                  <Animatable.View
                    duration={2000}
                    animation="zoomIn"
                    iterationCount={1}
                    style={[FeaturedTypeStyle.container, { width: wp(20), paddingHorizontal: wp('2'), paddingVertical: wp('0'), backgroundColor: "#f8f8f8" }]}
                    direction="alternate">
                    <Image
                      style={[FeaturedTypeStyle.image, { height: wp(13), width: wp(13) }]}
                      source={{ uri: item.img }} />
                  </Animatable.View>

                  <Text style={[{ color: '#000', fontSize: wp(2), backgroundColor: '#fff', paddingVertical: wp(1), marginBottom: wp(2), paddingHorizontal: wp(4), fontWeight: '600' }]}>
                    {item.name}
                  </Text>
      ...
      case '7':
        return (<View>
          ...
          <View style={[styles.featuredTypeListContainer, { flexDirection: 'row', alignItems: 'center' }]}>
            <Image
              style={[FeaturedTypeStyle.image, { width: wp(26), alignSelf: 'center', marginRight: wp(3) }]}
  ...
  renderFeaturedAdsGrid = () => {
    ...
    switch (featuredAdType) {
      ...
      case '5':
        return (
          <View style={{ backgroundColor: '#F8F8F8', marginTop: wp(2) }}>
      ...
      case '6':
        return (
          <View>
            ...
            <View style={[styles.featuredGrid, { backgroundColor: '#fff', marginLeft: wp(0) }]}>
                  ...
                  >
                    ...
                    <View style={{ width: '100%', height: 120 }}>
                      <View style={[FeaturedGridStyle.textContainer, { width: '100%', backgroundColor: '#171A1F' }]}>
                        <Text style={[FeaturedGridStyle.brandTextStyle, { color: '#fff', fontWeight: '800', width: wp(48), fontSize: wp(3) }]}>
                          {item.ad_title}
                        </Text>
  ...
  renderFearuredMaker = () => {
    ...
    switch (makeType) {
      ...
      case '3':
        return (
          <View style={{ backgroundColor: '#fff', marginTop: wp(2), paddingLeft: wp(1) }}>
  ...
  //     <View style={[xxxx==1?{ marginTop: wp('-23') }:null]}>
  ...
  //       <View style={[styles.featuredGrid, { marginTop: wp('0'), backgroundColor: 'transparent' }]}>
  ...
  //             <TouchableOpacity
  //               activeOpacity={1}
  //               style={[FeaturedGridStyle.container, { marginTop: wp('3'), backgroundColor: 'transparent', width: wp('43'), borderTopLeftRadius: wp('3'), borderTopRightRadius: wp('3') }]}
  //               onPress={() => this.onFeaturedGridClick(item)}
  //             >
  //               <View style={[FeaturedGridStyle.imageContainer, { borderTopLeftRadius: wp('3'), borderTopRightRadius: wp('3') }]}>
  //                 <Image
  ...
  //               <View style={{ marginLeft: wp('2'), }}>
  //                 <Text
  //                   style={[MakersTypeStyle.text, { fontSize: wp('3.2'), fontWeight: '600' }]}>
  //                   {item.name}
  //                 </Text>
  //                 <Text style={[FeaturedTypeStyle.text, { fontSize: wp('2.2') }]}>
  //                    {item.cat_count} ads
        ...
        <View style={styles.listRowContainer}>
          <FlatList
            ...
            renderItem={({ item, key }) => (
              <TouchableOpacity
                activeOpacity={1}
                style={[styles.listItemContainer, { backgroundColor: '#f1f1f1' }]}
                onPress={async () => {
                  const { navigate } = this.props.navigation;
                  await BackHandler.removeEventListener("hardwareBackPress", this.handleBackButton);
  ...
  render() {
    ...
    return (
      ...
      >
        <View>
          {/* Header Start */}
          <View style={[styles.header, { height: wp('70'), backgroundColor: '#1d2127', borderBottomLeftRadius: wp('8'), borderBottomRightRadius: wp('8'), paddingLeft: wp('0') }]}>
            <View style={[{ width: '100%', height: '100%', backgroundColor: '#1d2127', borderBottomLeftRadius: wp('8'), borderBottomRightRadius: wp('8') }]}>
              <View style={[styles.headerInnerContainer, { justifyContent: 'flex-start', padding: 0, }]}>
                <Text style={[styles.headerTitleText, { fontWeight: '600', fontSize: wp('7'), width: wp('66'), marginTop: wp('4') }]}>
                  {data.home_thme_header_title}
                </Text>

                <View style={[styles.headerSearchbarContainer, { marginTop: 8 }]}>

                  <TextInput
                    style={[styles.TextInput, { backgroundColor: '#171a1f', borderTopLeftRadius: Appearences.Radius.radius, borderBottomLeftRadius: Appearences.Radius.radius, color: '#fff' }]}
                  ...
                  >
                    <View style={[styles.searchButton, { backgroundColor: '#171a1f', borderTopEndRadius: Appearences.Radius.radius, borderBottomEndRadius: Appearences.Radius.radius }]}>
        ...
        <View style={[styles.container, { backgroundColor: '#fff', paddingHorizontal: wp('3') }]}>
